...
If you've been following along with the post in this series, you should recognize most of the items in the `dev/` scripts. Even if you are familiar with R package development, you can think of these scripts as a 'shiny app development checklist.' 

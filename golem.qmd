...
co_box(color = "b",
  ...
  contents = "After calling `usethis::use_data_raw('movies')`, I can use `system.file()` to locate the external data file with the following code in `data-raw/movies.R`:

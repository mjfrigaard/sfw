...
One of the constant concerns for developers is relying on an experimental or 'new' add-on dependency, the dependency introducing backward incompatible changes, and those changes breaking something they've built.

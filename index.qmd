...
The original data and code for each application comes from [Building Web Applications With Shiny](https://rstudio-education.github.io/shiny-course/)[^bwas], but has been adapted to provide a basic (but realistic) example (modules, utility function, tests, etc.)
...
Below is a dependency tree for `shiny`:

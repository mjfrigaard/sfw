...
co_box(
  ...
  fold = FALSE,
  contents = "
I've recently updated this website and rebuilt each app-package so they reflect the current features and dependencies for each framework. 
  "
)
```
...
remotes::install_github(repo = "mjfrigaard/gap")
```
...
#| code-fold: false 
install.packages('remotes')
remotes::install_github(repo = "mjfrigaard/lap")
```
...
[Download the `rap` source code](https://github.com/mjfrigaard/sfw/raw/main/_apps/rap.zip).

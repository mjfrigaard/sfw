...
server <- function(id) {
  ...
  moduleServer(id, function(input, output, session) {
    clicks$server("clicks") # <2>
    message$server("message") # <2>
  })
...
Cypress tests are stored in the `tests/cypress/integration/` folder:[^integration-vs-e2e]
...
[^integration-vs-e2e]: The folder names are slightly different in the [Cypress tutorial](https://appsilon.github.io/rhino/articles/tutorial/write-end-to-end-tests-with-cypress.html#how-to-run-cypress-tests), but if you replace `e2e` with integration in the file paths, everything works!
...
#| eval: false 
#| code-fold: show
#| code-summary: 'hide/view initial tests/cypress/integration/app.spec.js test'
  (Run Starting)
...
#| eval: false 
#| code-fold: show
#| code-summary: 'hide/view tests/cypress/integration/message.cy.js test'
  (Run Starting)
...
:::{#fig-cypress_message_01}

![Cypress test recording](img/cypress_message_01.gif){#fig-cypress_message_01 fig-align="center" width="100%"}


Contents of `tests/cypress/videos/message.cy.js.mp4`
:::
...
![Cypress app](img/cypress_open.gif){#fig-cypress_open fig-align="center" width="100%"}


The Cypress appliction 
:::

After the application opens, you'll be able to select the browser (I have Chrome selected)


:::{#fig-cypress_open_finally}

![Run cypress tests](img/cypress_open_finally.gif){#fig-cypress_open_finally fig-align="center" width="100%"}


Run the tests in `tests/cypress/integration/`
:::
...
:::{#fig-cypress_open_chrome}

![Chrome from cypress](img/cypress_open_chrome.gif){#fig-cypress_open_chrome fig-align="center" width="100%"}


Open application in Chrome from cypress
:::

Below is a screenshot of our tests listed in the sidebar:

:::{#fig-cypress_chrome_tests}

![Chrome tests](img/cypress_chrome_tests.png){#fig-cypress_chrome_tests fig-align="center" width="100%"}
...
:::{#fig-cypress_chrome_test_result}

![Test results](img/cypress_chrome_test_result.png){#fig-cypress_chrome_test_result fig-align="center" width="100%"}

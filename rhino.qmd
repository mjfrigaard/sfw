...
`rhino` apps aren't packages. Instead, they use the [`box`](https://klmr.me/box/) package to build modules, which '*completely replaces the base R `library` and `require` functions.*'

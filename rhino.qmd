...
It's important to keep these differences in mind when writing your own `shinytest2` tests. For example, the system tests from `moviesApp` [^feature-1-system-tests] would need to re-written: 

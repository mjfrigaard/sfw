...
- Lockfile written to "~/projects/apps/R/rap/renv.lock".
- Project '~/projects/apps/R/rap' loaded. [renv 1.1.8]
```
...
The output from the `rhino::test_r()` function now shows: 
...
DevTools listening on ws://127.0.0.1:63378/devtools/browser/40f34544-11e4-4b1e-a919-caa05400f0f2
...
================================================================================
  ...
  │ Cypress:        13.6.2                                                                         │
  │ Browser:        Electron 114 (headless)                                                        │
  │ Node Version:   v25.8.1 (/usr/local/Cellar/node/25.8.1_1/bin/node)                             │
...
────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  Show message
    ✓ 'Show message' button exists (760ms)
    ✓ 'Show message' button shows the message' (1158ms)

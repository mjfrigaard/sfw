...
**[`packer::scaffold_leprechaun()`](https://packer.john-coene.com/#/references/scaffold_leprechaun)** builds the scaffolding for `packer`:[^packer-scaffold]
...
::: {style='font-size: 1.05em; font-weight: bold; color: #ff0000;'}

**[Issue:](https://github.com/JohnCoene/packer/issues/31)** Issue with packer::scaffold_leprechaun() (or maybe leprechaun::build()?
...
![`send_message()` from `R/server.R`](img/leprechaun_message.png){width="70%" fig-align="center"}
...
More application resources (CSS, SASS, JavaScript files) are added using one of the `leprechaun::use_*` functions:
...
![run `lap`](img/initial_lap_run.png){width="100%" fig-align="center"}
...
co_box(
  ...
  header = "**Is my leprechaun app _'leaner and smaller'_ than my golem app?**", 
  contents = "
